...
class Page{
    ...
    public function show() {
        ...
        if($this->totalPages > $this->rollPage && ($this->nowPage - $now_cool_page) >= 1){
            $the_first = '<li class=""><a href="' . $this->url(1) . '">' . $this->config['first'] . '</a></li>';
        }
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page > 0 && $this->totalPages != 1){
                    $link_page .= '<li class="am-active"><a href="javascript:;">' . $page . '</a></li>';
                }
            }
        }
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<ul class='am-pagination am-pagination-centered'>{$page_str}</ul>";
    }
}
